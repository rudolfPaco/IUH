...
public class IUBoton extends JButton {
    ...
    public IUBoton(IUPanel panel, Area area, String texto, String urlImagen, int sizeIcon, int distanciaTextIcon, int positionTextH, int positionTextV, char mnemonic, String toolTipText) {
        super(texto);
        this.panel = panel;
        this.urlImagen = urlImagen;
        this.area = area;
