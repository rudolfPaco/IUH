...
public class IUPanelTC extends IUPanel{
     ...
     * @param posicionHTexto
     * @param colorFondo
     * @param colorTitulo
     * @param placeHolder
     */
    public IUPanelTC(IUPanel panel, Area areaPanel, int x, int y, int altoTitulo, String titulo, int nroColumnas, String texto, int sizeTitulo, int sizeCampo, int posicionHTitulo, int posicionHTexto, Color colorFondo, Color colorTitulo, String placeHolder){
    ...
    private void construirPanel(){
        ...
        iuCampo = new IUCampoTexto(this, new Area(x*2, area.AlP(altoTitulo), area.An() - y*4, area.AlP(100 - altoTitulo) - y*2), nroColumnas, sizeCampo, posicionHTexto);
